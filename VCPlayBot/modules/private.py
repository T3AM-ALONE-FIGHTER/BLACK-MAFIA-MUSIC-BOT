    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 Updates", url=f"https://t.me/BLACK_MAFIA_OP"), 
                    InlineKeyboardButton(
                        "💬 Support", url=f"https://t.me/BLACK_MAFIA_OP")
                ],[
                    InlineKeyboardButton(
                        "🛠 Source Code 🛠", url=f"BHAI YAAR THUM GAAND MARO")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Support Chat", url=f" https://t.me/BLACK_MAFIA_OP"
                    )
                ]
            ]
        ),
